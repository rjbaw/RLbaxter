...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -pthread -D__EXTENSIONS__' CPPFLAGS='-I/home/nvidia/Downloads/openmpi-4.0.0/opal/mca/event/libevent2022/libevent -I/home/nvidia/Downloads/openmpi-4.0.0/opal/mca/event/libevent2022/libevent/include -I/home/nvidia/Downloads/openmpi-4.0.0/opal/mca/hwloc/hwloc201/hwloc/include  ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OPAL_PACKAGE_STRING "Open MPI nvidia@jetson-0423318029132 Distribution"
