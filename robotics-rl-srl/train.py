...
# For anyone using tensorflow and mpi4py
# GPU processing
...
# Occasionally random errors here, finding a solution
...
#    args = get_args() ; needs separation of unknown and known argparse
    env_kwargs = {}
